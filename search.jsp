...
<head>
    ...
    String sql = "select * from demo where 기관명 LIKE ? OR 고객번호 LIKE ? OR 데모ID LIKE ? OR 데모PW LIKE ? OR 상호명 LIKE ? OR 고객명 LIKE ? OR 담당대리점 LIKE ? OR 담당자명 LIKE ? OR 사용여부 LIKE ? OR PACS LIKE ? OR EMR LIKE ? ORDER BY idx"; 
    ...
    pstmt.setString(10, "%" + word + "%");
    pstmt.setString(11, "%" + word + "%");
